...
Kyle Goodman tops the list at about $10,594 of lifetime revenue, and the tenth spot on the list comes in around $8,263.
...
The identity behind `cking@gmail.com` spans **four accounts** - Cory May, Ryan Bautista, Patrick Yoder, Christian King - with a combined **$12,819** of successful revenue.  None of which appear anywhere on the top-10 list we ran at the start of this lab, because no single one of their accounts is big enough to crack it.
